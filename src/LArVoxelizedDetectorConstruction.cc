...
G4VPhysicalVolume* LArVoxelizedDetectorConstruction::Construct()
{
  ...
  G4LogicalVolume* logical_target0
    = new G4LogicalVolume(target0,
			  ...
			  "lv_target0");
  new G4PVPlacement(0,
		    //G4ThreeVector(0.0*m, 0.0*m, -0.5*cryo_z - 0.5*tar_z - 10.0*cm + 0.0*tar_z),
  ...
  G4LogicalVolume* logical_target1
    = new G4LogicalVolume(target1,
			  ...
			  "lv_target1");
  new G4PVPlacement(0,
		    //G4ThreeVector(0.0*m, 0.0*m, -0.5*cryo_z - 0.5*tar_z - 10.0*cm + 1.0*tar_z),
  ...
  G4LogicalVolume* logical_target2
    = new G4LogicalVolume(target2,
			  ...
			  "lv_target2");
  new G4PVPlacement(0,
		    //G4ThreeVector(0.0*m, 0.0*m, -0.5*cryo_z - 0.5*tar_z - 10.0*cm + 2.0*tar_z),
  ...
  G4Box* target3
    = new G4Box("bx_target3",
		0.5*tar_x,
		0.5*tar_y,
		0.5*tar_z);
  G4LogicalVolume* logical_target3
    = new G4LogicalVolume(target3,
			  n_layers > 3 ? target_mat : ambient_mat,
			  "lv_target3");
  new G4PVPlacement(0,
		    //G4ThreeVector(0.0*m, 0.0*m, -0.5*cryo_z - 0.5*tar_z - 10.0*cm + 3.0*tar_z),
		    G4ThreeVector(0.0*m, 0.0*m, -0.5*cryo_z - 0.5*tar_z - 40.0*cm),
		    logical_target3,
		    "sv_target3",
		    logical_world,
		    false,
  ...
  G4Box* target4
    = new G4Box("bx_target4",
		0.5*tar_x,
		0.5*tar_y,
		0.5*tar_z);
  G4LogicalVolume* logical_target4
    = new G4LogicalVolume(target4,
			  n_layers > 4 ? target_mat : ambient_mat,
			  "lv_target4");
  new G4PVPlacement(0,
		    //G4ThreeVector(0.0*m, 0.0*m, -0.5*cryo_z - 0.5*tar_z - 10.0*cm + 4.0*tar_z),
		    G4ThreeVector(0.0*m, 0.0*m, -0.5*cryo_z - 0.5*tar_z - 50.0*cm),
		    logical_target4,
		    "sv_target4",
		    logical_world,
		    false,
